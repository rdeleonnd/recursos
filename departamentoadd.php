	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["departamento_id"] != "") {
				...
				$this->setKey("departamento_id", $this->departamento_id->CurrentValue); // Set up key
			} else {
				$this->setKey("departamento_id", ""); // Clear key
	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$this->departamento_id->setDbValue($conn->Insert_ID());
				$rsnew['departamento_id'] = $this->departamento_id->DbValue;
			}
		} else {
...
fdepartamentoadd.Lists["x_area_id"] = {"LinkField":"x_area_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
