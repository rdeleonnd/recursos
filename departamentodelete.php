...
class cdepartamento_delete extends cdepartamento {
	...
	function RenderRow() {
		...
		$this->departamento_id->CellCssStyle = "white-space: nowrap;";
...
fdepartamentodelete.Lists["x_area_id"] = {"LinkField":"x_area_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php } ?>
<?php if ($departamento->area_id->Visible) { // area_id ?>
		<th><span id="elh_departamento_area_id" class="departamento_area_id"><?php echo $departamento->area_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($departamento->area_id->Visible) { // area_id ?>
		<td<?php echo $departamento->area_id->CellAttributes() ?>>
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_area_id" class="departamento_area_id">
<span<?php echo $departamento->area_id->ViewAttributes() ?>>
<?php echo $departamento->area_id->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
