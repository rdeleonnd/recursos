...
class cuser_edit extends cuser {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// session
			$this->session->SetDbValueDef($rsnew, $this->session->CurrentValue, NULL, $this->session->ReadOnly);

			// enterprise_id
			$this->enterprise_id->SetDbValueDef($rsnew, $this->enterprise_id->CurrentValue, NULL, $this->enterprise_id->ReadOnly);
...
fuseredit.Lists["x_userlevel_id"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuseredit.Lists["x_state"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuseredit.Lists["x_state"].Options = <?php echo json_encode($user->state->Options()) ?>;
