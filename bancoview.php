...
class cbanco_view extends cbanco {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["banco_id"] <> "") {
			$this->RecKey["banco_id"] = $_GET["banco_id"];
			$KeyUrl .= "&amp;banco_id=" . urlencode($this->RecKey["banco_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["banco_id"] <> "") {
				...
				$this->RecKey["banco_id"] = $this->banco_id->QueryStringValue;
			} elseif (@$_POST["banco_id"] <> "") {
				$this->banco_id->setFormValue($_POST["banco_id"]);
				$this->RecKey["banco_id"] = $this->banco_id->FormValue;
			} else {
