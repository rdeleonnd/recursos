...
$informacion_academica_view = NULL; // Initialize page object first

class cinformacion_academica_view extends cinformacion_academica {
	...
	// Page object name
	var $PageObjName = 'informacion_academica_view';
	...
	function __construct() {
		...
		if (@$_GET["informacion_academica_id"] <> "") {
			$this->RecKey["informacion_academica_id"] = $_GET["informacion_academica_id"];
			$KeyUrl .= "&amp;informacion_academica_id=" . urlencode($this->RecKey["informacion_academica_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["informacion_academica_id"] <> "") {
				...
				$this->RecKey["informacion_academica_id"] = $this->informacion_academica_id->QueryStringValue;
			} elseif (@$_POST["informacion_academica_id"] <> "") {
				$this->informacion_academica_id->setFormValue($_POST["informacion_academica_id"]);
				$this->RecKey["informacion_academica_id"] = $this->informacion_academica_id->FormValue;
			} else {
				$sReturnUrl = "informacion_academicalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "informacion_academicalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "informacion_academicalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($informacion_academica_view)) $informacion_academica_view = new cinformacion_academica_view();

// Page init
$informacion_academica_view->Page_Init();

// Page main
$informacion_academica_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$informacion_academica_view->Page_Render();
?>
...
var CurrentForm = finformacion_academicaview = new ew_Form("finformacion_academicaview", "view");

// Form_CustomValidate event
finformacion_academicaview.Form_CustomValidate = 
...
finformacion_academicaview.ValidateRequired = true;
<?php } else { ?>
finformacion_academicaview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
finformacion_academicaview.Lists["x_empleado_id"] = {"LinkField":"x_empleado_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_apellido","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $informacion_academica_view->ExportOptions->Render("body") ?>
<?php
	foreach ($informacion_academica_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $informacion_academica_view->ShowPageHeader(); ?>
<?php
$informacion_academica_view->ShowMessage();
?>
<form name="finformacion_academicaview" id="finformacion_academicaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($informacion_academica_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $informacion_academica_view->Token ?>">
<?php } ?>
...
<?php if ($informacion_academica->establecimiento->Visible) { // establecimiento ?>
	<tr id="r_establecimiento">
		<td><span id="elh_informacion_academica_establecimiento"><?php echo $informacion_academica->establecimiento->FldCaption() ?></span></td>
...
<?php echo $informacion_academica->establecimiento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($informacion_academica->grado_academico->Visible) { // grado_academico ?>
	<tr id="r_grado_academico">
		<td><span id="elh_informacion_academica_grado_academico"><?php echo $informacion_academica->grado_academico->FldCaption() ?></span></td>
...
<?php echo $informacion_academica->grado_academico->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($informacion_academica->fecha_inicio->Visible) { // fecha_inicio ?>
	<tr id="r_fecha_inicio">
		<td><span id="elh_informacion_academica_fecha_inicio"><?php echo $informacion_academica->fecha_inicio->FldCaption() ?></span></td>
...
<?php echo $informacion_academica->fecha_inicio->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($informacion_academica->fecha_fin->Visible) { // fecha_fin ?>
	<tr id="r_fecha_fin">
		<td><span id="elh_informacion_academica_fecha_fin"><?php echo $informacion_academica->fecha_fin->FldCaption() ?></span></td>
...
<?php echo $informacion_academica->fecha_fin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($informacion_academica->titulo_obtenido->Visible) { // titulo_obtenido ?>
	<tr id="r_titulo_obtenido">
		<td><span id="elh_informacion_academica_titulo_obtenido"><?php echo $informacion_academica->titulo_obtenido->FldCaption() ?></span></td>
...
<?php echo $informacion_academica->titulo_obtenido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($informacion_academica->empleado_id->Visible) { // empleado_id ?>
	<tr id="r_empleado_id">
		<td><span id="elh_informacion_academica_empleado_id"><?php echo $informacion_academica->empleado_id->FldCaption() ?></span></td>
...
<?php echo $informacion_academica->empleado_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
finformacion_academicaview.Init();
</script>
<?php
$informacion_academica_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$informacion_academica_view->Page_Terminate();
?>
