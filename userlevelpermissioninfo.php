...
$userlevelpermission = NULL;

//
// Table class for userlevelpermission
//
class cuserlevelpermission extends cTable {
	var $userlevelid;
	var $_tablename;
	var $permission;
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "`userlevelpermission`";
		$this->DBID = 'DB';
		...
		// userlevelid
		$this->userlevelid = new cField('userlevelpermission', 'userlevelpermission', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->userlevelid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userlevelid'] = &$this->userlevelid;

		// tablename
		$this->_tablename = new cField('userlevelpermission', 'userlevelpermission', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['tablename'] = &$this->_tablename;

		// permission
		$this->permission = new cField('userlevelpermission', 'userlevelpermission', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`userlevelpermission`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "userlevelpermissionlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("userlevelpermissionview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("userlevelpermissionview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "userlevelpermissionadd.php?" . $this->UrlParm($parm);
		else
			$url = "userlevelpermissionadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("userlevelpermissionedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("userlevelpermissionadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("userlevelpermissiondelete.php", $this->UrlParm());
	}
