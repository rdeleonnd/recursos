...
$cuenta_bancaria_edit = NULL; // Initialize page object first

class ccuenta_bancaria_edit extends ccuenta_bancaria {
	...
	// Page object name
	var $PageObjName = 'cuenta_bancaria_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->cuenta_bancaria_id->CurrentValue == "")
			$this->Page_Terminate("cuenta_bancarialist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		if (!$this->cuenta_bancaria_id->FldIsDetailKey)
			$this->cuenta_bancaria_id->setFormValue($objForm->GetValue("x_cuenta_bancaria_id"));
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->cuenta_bancaria_id->CurrentValue = $this->cuenta_bancaria_id->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// banco_id
			$this->banco_id->SetDbValueDef($rsnew, $this->banco_id->CurrentValue, 0, $this->banco_id->ReadOnly);

			// numero_cuenta
			$this->numero_cuenta->SetDbValueDef($rsnew, $this->numero_cuenta->CurrentValue, "", $this->numero_cuenta->ReadOnly);
...
// Create page object
if (!isset($cuenta_bancaria_edit)) $cuenta_bancaria_edit = new ccuenta_bancaria_edit();

// Page init
$cuenta_bancaria_edit->Page_Init();

// Page main
$cuenta_bancaria_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cuenta_bancaria_edit->Page_Render();
?>
...
var CurrentForm = fcuenta_bancariaedit = new ew_Form("fcuenta_bancariaedit", "edit");

// Validate form
fcuenta_bancariaedit.Validate = function() {
...
fcuenta_bancariaedit.Form_CustomValidate = 
...
fcuenta_bancariaedit.ValidateRequired = true;
<?php } else { ?>
fcuenta_bancariaedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcuenta_bancariaedit.Lists["x_banco_id"] = {"LinkField":"x_banco_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcuenta_bancariaedit.Lists["x_empleado_id"] = {"LinkField":"x_empleado_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_apellido","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $cuenta_bancaria_edit->ShowPageHeader(); ?>
<?php
$cuenta_bancaria_edit->ShowMessage();
?>
<form name="fcuenta_bancariaedit" id="fcuenta_bancariaedit" class="<?php echo $cuenta_bancaria_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cuenta_bancaria_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cuenta_bancaria_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="cuenta_bancaria" data-field="x_cuenta_bancaria_id" name="x_cuenta_bancaria_id" id="x_cuenta_bancaria_id" value="<?php echo ew_HtmlEncode($cuenta_bancaria->cuenta_bancaria_id->CurrentValue) ?>">
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cuenta_bancaria_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fcuenta_bancariaedit.Init();
</script>
<?php
$cuenta_bancaria_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cuenta_bancaria_edit->Page_Terminate();
?>
