...
define("EW_PROJECT_NAME", "recursos_humanos", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{8127A4B8-77E3-4A91-B475-0A98E2BB4762}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'muBPa279CdqOq8P9', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/recursos_humanos.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "proceso", "pass" => "nd", "db" => "recursos_humanos", "qs" => "`", "qe" => "`");
...
// Security
define("EW_ADMIN_USER_NAME", "jose", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "1.9", TRUE); // Administrator password
...
@define("EW_USER_LEVEL_TABLE", "`userlevel`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`userlevelpermission`", TRUE);
...
define("EW_USER_PROFILE_FIELD_NAME", "session", TRUE);
...
define("EW_USER_PROFILE_SESSION_TIMEOUT", 30, TRUE);
