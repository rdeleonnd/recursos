	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["municipio_id"] != "") {
				...
				$this->setKey("municipio_id", $this->municipio_id->CurrentValue); // Set up key
			} else {
				$this->setKey("municipio_id", ""); // Clear key
	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$this->municipio_id->setDbValue($conn->Insert_ID());
				$rsnew['municipio_id'] = $this->municipio_id->DbValue;
			}
		} else {
...
fmunicipioadd.Lists["x_departamento_id"] = {"LinkField":"x_departamento_origen_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
