...
//
class cuserlevel extends cTable {
	var $userlevelid;
	var $userlevelname;
	...
	function __construct() {
		...
		$this->TableVar = 'userlevel';
		$this->TableName = 'userlevel';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`userlevel`";
		$this->DBID = 'DB';
		...
		// userlevelid
		$this->userlevelid = new cField('userlevel', 'userlevel', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->userlevelid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userlevelid'] = &$this->userlevelid;

		// userlevelname
		$this->userlevelname = new cField('userlevel', 'userlevel', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`userlevel`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("userlevelview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("userlevelview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "userleveladd.php?" . $this->UrlParm($parm);
		else
			$url = "userleveladd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("userleveledit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("userleveladd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("userleveldelete.php", $this->UrlParm());
	}
