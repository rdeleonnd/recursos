...
class cdepartamento_edit extends cdepartamento {
	...
	function Page_Init() {
		...
		$this->departamento_id->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if (@$_GET["departamento_id"] <> "") {
			$this->departamento_id->setQueryStringValue($_GET["departamento_id"]);
		}
		...
		// Check if valid key
		if ($this->departamento_id->CurrentValue == "")
	...
	function RenderRow() {
		...
		$this->area_id->ViewCustomAttributes = "";
			...
			$this->departamento_id->EditValue = $this->departamento_id->CurrentValue;
			$this->departamento_id->ViewCustomAttributes = "";
...
fdepartamentoedit.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $departamento->area_id->FldCaption(), $departamento->area_id->ReqErrMsg)) ?>");
...
fdepartamentoedit.Lists["x_area_id"] = {"LinkField":"x_area_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<div>
<?php if ($departamento->departamento_id->Visible) { // departamento_id ?>
	<div id="r_departamento_id" class="form-group">
		<label id="elh_departamento_departamento_id" class="col-sm-2 control-label ewLabel"><?php echo $departamento->departamento_id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $departamento->departamento_id->CellAttributes() ?>>
<span id="el_departamento_departamento_id">
<span<?php echo $departamento->departamento_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $departamento->departamento_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="departamento" data-field="x_departamento_id" name="x_departamento_id" id="x_departamento_id" value="<?php echo ew_HtmlEncode($departamento->departamento_id->CurrentValue) ?>">
<?php echo $departamento->departamento_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($departamento->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_departamento_nombre" for="x_nombre" class="col-sm-2 control-label ewLabel"><?php echo $departamento->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<input type="text" data-table="departamento" data-field="x_estado" name="x_estado" id="x_estado" size="30" maxlength="8" placeholder="<?php echo ew_HtmlEncode($departamento->estado->getPlaceHolder()) ?>" value="<?php echo $departamento->estado->EditValue ?>"<?php echo $departamento->estado->EditAttributes() ?>>
</span>
...
<?php if ($departamento->area_id->Visible) { // area_id ?>
	<div id="r_area_id" class="form-group">
		<label id="elh_departamento_area_id" for="x_area_id" class="col-sm-2 control-label ewLabel"><?php echo $departamento->area_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $departamento->area_id->CellAttributes() ?>>
<span id="el_departamento_area_id">
...
if (is_array($departamento->area_id->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = ew_SameStr($departamento->area_id->CurrentValue, $arwrk[$rowcntwrk][0]) ? " selected" : "";
...
<?php echo $departamento->area_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
