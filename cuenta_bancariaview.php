...
$cuenta_bancaria_view = NULL; // Initialize page object first

class ccuenta_bancaria_view extends ccuenta_bancaria {
	...
	// Page object name
	var $PageObjName = 'cuenta_bancaria_view';
	...
	function __construct() {
		...
		if (@$_GET["cuenta_bancaria_id"] <> "") {
			$this->RecKey["cuenta_bancaria_id"] = $_GET["cuenta_bancaria_id"];
			$KeyUrl .= "&amp;cuenta_bancaria_id=" . urlencode($this->RecKey["cuenta_bancaria_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["cuenta_bancaria_id"] <> "") {
				...
				$this->RecKey["cuenta_bancaria_id"] = $this->cuenta_bancaria_id->QueryStringValue;
			} elseif (@$_POST["cuenta_bancaria_id"] <> "") {
				$this->cuenta_bancaria_id->setFormValue($_POST["cuenta_bancaria_id"]);
				$this->RecKey["cuenta_bancaria_id"] = $this->cuenta_bancaria_id->FormValue;
			} else {
				$sReturnUrl = "cuenta_bancarialist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cuenta_bancarialist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "cuenta_bancarialist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($cuenta_bancaria_view)) $cuenta_bancaria_view = new ccuenta_bancaria_view();

// Page init
$cuenta_bancaria_view->Page_Init();

// Page main
$cuenta_bancaria_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cuenta_bancaria_view->Page_Render();
?>
...
var CurrentForm = fcuenta_bancariaview = new ew_Form("fcuenta_bancariaview", "view");

// Form_CustomValidate event
fcuenta_bancariaview.Form_CustomValidate = 
...
fcuenta_bancariaview.ValidateRequired = true;
<?php } else { ?>
fcuenta_bancariaview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fcuenta_bancariaview.Lists["x_banco_id"] = {"LinkField":"x_banco_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcuenta_bancariaview.Lists["x_empleado_id"] = {"LinkField":"x_empleado_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_apellido","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $cuenta_bancaria_view->ExportOptions->Render("body") ?>
<?php
	foreach ($cuenta_bancaria_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $cuenta_bancaria_view->ShowPageHeader(); ?>
<?php
$cuenta_bancaria_view->ShowMessage();
?>
<form name="fcuenta_bancariaview" id="fcuenta_bancariaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cuenta_bancaria_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cuenta_bancaria_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cuenta_bancaria">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($cuenta_bancaria->banco_id->Visible) { // banco_id ?>
	<tr id="r_banco_id">
		<td><span id="elh_cuenta_bancaria_banco_id"><?php echo $cuenta_bancaria->banco_id->FldCaption() ?></span></td>
...
<?php echo $cuenta_bancaria->banco_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuenta_bancaria->numero_cuenta->Visible) { // numero_cuenta ?>
	<tr id="r_numero_cuenta">
		<td><span id="elh_cuenta_bancaria_numero_cuenta"><?php echo $cuenta_bancaria->numero_cuenta->FldCaption() ?></span></td>
...
<?php echo $cuenta_bancaria->numero_cuenta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuenta_bancaria->empleado_id->Visible) { // empleado_id ?>
	<tr id="r_empleado_id">
		<td><span id="elh_cuenta_bancaria_empleado_id"><?php echo $cuenta_bancaria->empleado_id->FldCaption() ?></span></td>
...
<?php echo $cuenta_bancaria->empleado_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fcuenta_bancariaview.Init();
</script>
<?php
$cuenta_bancaria_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cuenta_bancaria_view->Page_Terminate();
?>
