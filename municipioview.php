...
class cmunicipio_view extends cmunicipio {
	...
	function __construct() {
		...
		if (@$_GET["municipio_id"] <> "") {
			$this->RecKey["municipio_id"] = $_GET["municipio_id"];
			$KeyUrl .= "&amp;municipio_id=" . urlencode($this->RecKey["municipio_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["municipio_id"] <> "") {
				...
				$this->RecKey["municipio_id"] = $this->municipio_id->QueryStringValue;
			} elseif (@$_POST["municipio_id"] <> "") {
				$this->municipio_id->setFormValue($_POST["municipio_id"]);
				$this->RecKey["municipio_id"] = $this->municipio_id->FormValue;
			} else {
...
fmunicipioview.Lists["x_departamento_id"] = {"LinkField":"x_departamento_origen_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($municipio->departamento_id->Visible) { // departamento_id ?>
	<tr id="r_departamento_id">
		<td><span id="elh_municipio_departamento_id"><?php echo $municipio->departamento_id->FldCaption() ?></span></td>
...
<?php echo $municipio->departamento_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
