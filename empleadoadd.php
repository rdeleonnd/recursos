...
class cempleado_add extends cempleado {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["empleado_id"] != "") {
				...
				$this->setKey("empleado_id", $this->empleado_id->CurrentValue); // Set up key
			} else {
				$this->setKey("empleado_id", ""); // Clear key
	...
	function LoadDefaultValues() {
		...
		$this->departamento_origen_id->CurrentValue = NULL;
		$this->departamento_origen_id->OldValue = $this->departamento_origen_id->CurrentValue;
		$this->municipio_id->CurrentValue = NULL;
		$this->municipio_id->OldValue = $this->municipio_id->CurrentValue;
		$this->telefono_residencia->CurrentValue = NULL;
		$this->telefono_residencia->OldValue = $this->telefono_residencia->CurrentValue;
		$this->telefono_celular->CurrentValue = NULL;
		$this->telefono_celular->OldValue = $this->telefono_celular->CurrentValue;
		$this->fecha_nacimiento->CurrentValue = NULL;
		$this->fecha_nacimiento->OldValue = $this->fecha_nacimiento->CurrentValue;
		$this->nacionalidad->CurrentValue = NULL;
		$this->nacionalidad->OldValue = $this->nacionalidad->CurrentValue;
		...
		$this->igss->CurrentValue = NULL;
		$this->igss->OldValue = $this->igss->CurrentValue;
		$this->nit->CurrentValue = NULL;
		$this->nit->OldValue = $this->nit->CurrentValue;
		$this->licencia_conducir->CurrentValue = NULL;
		$this->licencia_conducir->OldValue = $this->licencia_conducir->CurrentValue;
		$this->area_id->CurrentValue = NULL;
		$this->area_id->OldValue = $this->area_id->CurrentValue;
		$this->departmento_id->CurrentValue = NULL;
		$this->departmento_id->OldValue = $this->departmento_id->CurrentValue;
		$this->seccion_id->CurrentValue = NULL;
		$this->seccion_id->OldValue = $this->seccion_id->CurrentValue;
		$this->puesto_id->CurrentValue = NULL;
		$this->puesto_id->OldValue = $this->puesto_id->CurrentValue;
		$this->observaciones->CurrentValue = NULL;
		$this->observaciones->OldValue = $this->observaciones->CurrentValue;
		$this->tipo_sangre_id->CurrentValue = NULL;
		$this->tipo_sangre_id->OldValue = $this->tipo_sangre_id->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// departamento_origen_id
		$this->departamento_origen_id->SetDbValueDef($rsnew, $this->departamento_origen_id->CurrentValue, 0, FALSE);

		// municipio_id
		$this->municipio_id->SetDbValueDef($rsnew, $this->municipio_id->CurrentValue, 0, FALSE);

		// telefono_residencia
		$this->telefono_residencia->SetDbValueDef($rsnew, $this->telefono_residencia->CurrentValue, NULL, FALSE);

		// telefono_celular
		$this->telefono_celular->SetDbValueDef($rsnew, $this->telefono_celular->CurrentValue, NULL, FALSE);

		// fecha_nacimiento
		$this->fecha_nacimiento->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->fecha_nacimiento->CurrentValue, 7), ew_CurrentDate(), FALSE);

		// nacionalidad
		$this->nacionalidad->SetDbValueDef($rsnew, $this->nacionalidad->CurrentValue, 0, FALSE);

		// estado_civil
		$this->estado_civil->SetDbValueDef($rsnew, $this->estado_civil->CurrentValue, 0, FALSE);

		// sexo
		$this->sexo->SetDbValueDef($rsnew, $this->sexo->CurrentValue, 0, FALSE);

		// igss
		$this->igss->SetDbValueDef($rsnew, $this->igss->CurrentValue, NULL, FALSE);

		// nit
		$this->nit->SetDbValueDef($rsnew, $this->nit->CurrentValue, "", FALSE);

		// licencia_conducir
		$this->licencia_conducir->SetDbValueDef($rsnew, $this->licencia_conducir->CurrentValue, NULL, FALSE);

		// area_id
		$this->area_id->SetDbValueDef($rsnew, $this->area_id->CurrentValue, 0, FALSE);

		// departmento_id
		$this->departmento_id->SetDbValueDef($rsnew, $this->departmento_id->CurrentValue, 0, FALSE);

		// seccion_id
		$this->seccion_id->SetDbValueDef($rsnew, $this->seccion_id->CurrentValue, 0, FALSE);

		// puesto_id
		$this->puesto_id->SetDbValueDef($rsnew, $this->puesto_id->CurrentValue, 0, FALSE);

		// observaciones
		$this->observaciones->SetDbValueDef($rsnew, $this->observaciones->CurrentValue, "", FALSE);

		// tipo_sangre_id
		$this->tipo_sangre_id->SetDbValueDef($rsnew, $this->tipo_sangre_id->CurrentValue, 0, FALSE);
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$this->empleado_id->setDbValue($conn->Insert_ID());
				$rsnew['empleado_id'] = $this->empleado_id->DbValue;
			}
		} else {
...
fempleadoadd.Lists["x_departamento_origen_id"] = {"LinkField":"x_departamento_origen_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fempleadoadd.Lists["x_municipio_id"] = {"LinkField":"x_municipio_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fempleadoadd.Lists["x_nacionalidad"] = {"LinkField":"x_nacionalidad_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nacionalidad","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fempleadoadd.Lists["x_estado_civil"] = {"LinkField":"x_estado_civil_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_estado_civil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fempleadoadd.Lists["x_sexo"] = {"LinkField":"x_sexo_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sexo","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fempleadoadd.Lists["x_area_id"] = {"LinkField":"x_area_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fempleadoadd.Lists["x_departmento_id"] = {"LinkField":"x_departamento_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":["x_departmento_id"],"ChildFields":["x_departmento_id"],"FilterFields":["x_departamento_id"],"Options":[],"Template":""};
fempleadoadd.Lists["x_seccion_id"] = {"LinkField":"x_seccion_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":["x_seccion_id"],"ChildFields":["x_seccion_id"],"FilterFields":["x_seccion_id"],"Options":[],"Template":""};
fempleadoadd.Lists["x_puesto_id"] = {"LinkField":"x_puesto_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":["x_puesto_id"],"ChildFields":["x_puesto_id"],"FilterFields":["x_puesto_id"],"Options":[],"Template":""};
fempleadoadd.Lists["x_tipo_sangre_id"] = {"LinkField":"x_tipo_sangre_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipo_sangre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<script type="text/javascript">
ew_CreateCalendar("fempleadoadd", "x_fecha_nacimiento", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
fempleadoadd.CreateAutoSuggest({"id":"x_estado_civil","forceSelect":false});
</script>
</span>
...
<script type="text/javascript">
fempleadoadd.CreateAutoSuggest({"id":"x_sexo","forceSelect":false});
</script>
</span>
...
<script type="text/javascript">
fempleadoadd.CreateAutoSuggest({"id":"x_area_id","forceSelect":false});
</script>
</span>
